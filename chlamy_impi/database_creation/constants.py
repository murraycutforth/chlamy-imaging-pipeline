...
def get_time_regime_to_expected_intervals() -> dict[str, set[tuple]]:
    ...
    return {
        '30s-30s': {(29., 43.), (570, 605), (1760., 1861.), _dark_recovery},
        '1min-1min': {(59., 76.), (540, 558), (1730., 1860.), _dark_recovery},
        ...
        '20h_HL': {(1540., 1620.), (1730., 1860.), (5350., 5450.), (599, 607), _dark_recovery},
    }
